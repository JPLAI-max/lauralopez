      ...
      <section className="relative h-[100dvh] min-h-[800px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center text-white">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl mx-auto space-y-6">
            ...
            <motion.h2 variants={fadeUpVariant} className="font-sans text-xl md:text-2xl uppercase tracking-widest font-light text-white/90">
              Director, Beverly Hills Estates
            </motion.h2>
            <motion.h3 variants={fadeUpVariant} className="font-sans text-sm md:text-base tracking-wider uppercase opacity-80 pt-2">
              Advisor to Multi-Generational & High-Net-Worth Families
            </motion.h3>
            <motion.p variants={fadeUpVariant} className="font-serif text-xl md:text-2xl pt-8 pb-12 opacity-90 max-w-2xl mx-auto italic">
            ...
            <motion.div variants={fadeUpVariant} className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Link href="/contact" className="px-8 py-4 bg-secondary text-secondary-foreground uppercase tracking-wider text-sm hover:bg-secondary/90 transition-colors w-full sm:w-auto border border-secondary">
                Private Consultation
              </Link>
              <Link href="/market-intelligence" className="px-8 py-4 bg-transparent border border-white text-white uppercase tracking-wider text-sm hover:bg-white hover:text-primary transition-colors w-full sm:w-auto">
                Market Intelligence
              </Link>
            </motion.div>
          </motion.div>
      ...
      <section className="py-32 bg-background">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h3 className="font-serif text-4xl md:text-5xl text-foreground">Real Estate as Long-Term Strategy</h3>
        ...
        <div className="container mx-auto px-6">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUpVariant} className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              ...
              <h3 className="font-serif text-4xl text-foreground">Proprietary Research & Insights</h3>
            </div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div key={i} variants={fadeUpVariant} className="group cursor-pointer">
                <div className="bg-background p-8 border border-border h-full flex flex-col transition-shadow hover:shadow-lg">
                  <span className="font-sans text-xs uppercase tracking-widest text-secondary mb-6 block">{article.category}</span>
                  <h4 className="font-serif text-2xl mb-4 group-hover:text-primary transition-colors">{article.title}</h4>
                  ...
                  <span className="font-sans text-xs uppercase tracking-widest text-primary flex items-center gap-2">
                    Read Intelligence <span className="text-secondary opacity-0 group-hover:opacity-100 transition-opacity transform -translate-x-2 group-hover:translate-x-0">→</span>
                  </span>
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-32 bg-background">
        <div className="container mx-auto px-6">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUpVariant} className="mb-16">
            ...
            <h3 className="font-serif text-4xl text-foreground text-center">Laura's Top Picks</h3>
          ...
          <div className="space-y-24">
            {[
              ...
              <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUpVariant} className={`flex flex-col ${i % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-12 lg:gap-24 items-center`}>
                ...
                <div className="w-full lg:w-2/5 space-y-6">
                  ...
                  <h4 className="font-serif text-3xl">{pick.area}</h4>
      ...
      <section className="py-32 bg-primary text-primary-foreground">
        <div className="container mx-auto px-6 max-w-4xl">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUpVariant} className="text-center mb-16">
            <h2 className="font-serif text-4xl md:text-5xl mb-6 text-white">Begin a Confidential Conversation</h2>
            <p className="font-serif text-xl opacity-80 max-w-2xl mx-auto">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUpVariant} className="bg-white text-foreground p-8 md:p-12">
            <ContactForm />
          </motion.div>
        </div>
      </section>
